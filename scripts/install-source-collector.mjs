...
const command=`export PATH=\"/opt/homebrew/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin\"; cd \"${root}\" &amp;&amp; /opt/homebrew/opt/node@22/bin/node scripts/local-recovery.mjs`;
