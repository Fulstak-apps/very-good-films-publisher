...
test('source reposts require provenance and branding, preserve caption length',()=>{
 const x={kind:'source_repost',source_post_url:'https://www.instagram.com/moldedbyculture/reel/abc/',source_caption:'A film scene. '.repeat(100),film:{id:'ig:abc'},scene:{id:'abc',start:0,end:55},video_url:'https://example.com/a.mp4',asset_sha256:'a'.repeat(64),qa:{source_verified:true,media_verified:true,branding:'very-good-films-only-v1'}};
